...
--	ID_OBRA_SOCIAL INT NOT NULL,
--	ID_TIPO_ESPECIALIDAD INT NOT NULL,
--	CONSTRAINT PK_PROFESIONAL_MEDICO PRIMARY KEY (MATRICULA_MEDICO),
--	CONSTRAINT FK_PROFESIONAL_MEDICO_OBRA_SOCIAL FOREIGN KEY (ID_OBRA_SOCIAL)
--		REFERENCES OBRA_SOCIAL(ID_OBRA_SOCIAL),
--	CONSTRAINT FK_PROFESIONAL_MEDICO_ESPECIALIDADES FOREIGN KEY (ID_TIPO_ESPECIALIDAD)
--		REFERENCES ESPECIALIDADES(ID_TIPO_ESPECIALIDAD)
--);
